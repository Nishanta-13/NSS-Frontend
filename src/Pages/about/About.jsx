    ...
    <div className="about-page">
      ...
      <div className="container my-5 text-center">
        <p className="mb-2">
          ...
          cell of the National Institute of Technology (NIT) Silchar!
        </p>
        <p>
          Established with a vision to foster a spirit of social responsibility
          and community engagement among the youth, our NSS cell is committed to
        ...
        <p>
          ...
          every endeavor of our NSS cell is rooted in the spirit of service and
